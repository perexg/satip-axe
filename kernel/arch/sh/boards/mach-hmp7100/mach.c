/*
 * arch/sh/boards/mach-hmp7100/mach.c
 *
 ...
 *
 * Machine vector for the STMicroelectronics STb7100 HMa Pboard.
 */
...
static void __init hmp7100_init_irq(void)
{
...
static struct sh_machine_vector mv_hmp7100 __initmv = {
	...
	.mv_setup		= hmp7100_setup,
	.mv_nr_irqs		= NR_IRQS,
	.mv_init_irq		= hmp7100_init_irq,
	.mv_ioport_map		= hmp7100_ioport_map,
};
